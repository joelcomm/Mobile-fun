...
// happiness boost is.
export const TAP_HAPPINESS_COOLDOWN_MS = 1400;
...
export const MOOD_EVENT_MIN_MS = 35000;
export const MOOD_EVENT_MAX_MS = 95000;
...
// random per event.
export const MOOD_EVENT_BUBBLES = [
...
export function centerTierLabel(tier) {
    if (tier <= 0)
        return "";
    if (tier < CENTER_TIER_LABELS.length)
        return CENTER_TIER_LABELS[tier];
