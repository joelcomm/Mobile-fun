...
import { BREED_LABELS, CENTER_DOG_CAP_BONUS_MAX, CENTER_DOG_CAP_PER_TIER, CENTER_JOY_BONUS_PER_TIER, centerTierLabel, LV_UP_BASE, LV_UP_MULT, NAMING_COST_JOY, ROLE_INFO, GAME_WIDTH, } from "../config.js";
...
export class DogPanel extends Panel {
    ...
    drawTierUpgradeRow(y) {
        ...
        const info = scene.add.text(18, y + 6, `UPGRADE TIER ${tier}\n${msg}`, {
            fontFamily: "monospace",
            fontSize: "12px",
            color: "#2a2a3e",
            lineSpacing: 3,
