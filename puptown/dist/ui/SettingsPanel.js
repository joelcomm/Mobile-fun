...
export class SettingsPanel extends Panel {
    ...
    refresh() {
        ...
        const info = this.scene.add.text(20, y, `Version 0.1.0\nPlaytime: ${formatDuration(game.totalPlaytimeMs)}\nDogs: ${game.dogs.count()}\nReputation: ${Math.floor(game.resources.snapshot.reputation)}`, { fontFamily: "monospace", fontSize: "12px", color: "#2a2a3e", lineSpacing: 3 });
