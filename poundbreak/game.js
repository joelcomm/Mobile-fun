...
(function () {
  ...
  // L2 — procedurally generated maze (gen-mazes.mjs seed 7).
  const L2_MAP = [
    "111111111111111111111111",
    "1.....1...........1...11",
    "11111.1111111.111.1.1.11",
    "1...1.1.......1...1.1.11",
    "1.111.1.11111111111.1.11",
    "1.1...1.............1.11",
    "1.1.111.1111111111111.11",
    "1...1.....1.........1.11",
    "1.111111111.1111111.1.11",
    "1.1.....1...1....P1.1.11",
    "1.1.111.1.111.11111.1.11",
    "1.1...1...1...1...1....X",
    "1.111.11111.111.1.111.11",
    "1.....1...1...1.1.1...11",
    "1111111.1.1.1.1.1.1.1111",
    "1P1...1.1...1.1.1.1.1.11",
    "1.1.1.1.11111.1.1.1.1.11",
    "1.1.1...1P..1.1.1...1.11",
    "1.1.1111111.1.1.11111.11",
    "1...1P......1.1.1.....11",
    "1.11111.111.1.1.1.111.11",
    "1.......1P..1.....1...11",
    "111111111111111111111111",
    "111111111111111111111111",
  ];
  // L3 — procedurally generated maze (gen-mazes.mjs seed 42).
  const L3_MAP = [
    "111111111111111111111111",
    "1.1.....1.......1.....11",
    "1.1.111.111.111.1.1.1111",
    "1...1.1...1.1...1K1...11",
    "11111.111.1.1.1111111.11",
    "1.1.....1.1.1.........11",
    "1.1.1.111.1.111111111.11",
    "1.1.1.....1.........1.11",
    "1.1.11111111111.111.1.11",
    "1...1.........1...1.1.11",
    "1.111.1111111.11111.1.11",
    "1...1...1...........1.LX",
    "111.111.1111111111111.11",
    "1P1...1.......1....P1.11",
    "1.111.1111111.1.11111.11",
    "1..P1.........1.1...1.11",
    "1.1111111111111.1.1.1.11",
    "1.1.............1.1...11",
    "1.1.1.111111111.1.111111",
    "1.1.1.1...1...1P1...1P11",
    "1.1.1.1.1.1.1.11111.1.11",
    "1...1...1...1.........11",
    "111111111111111111111111",
    "111111111111111111111111",
  ];
  // L4 — procedurally generated maze (gen-mazes.mjs seed 99).
  const L4_MAP = [
    "111111111111111111111111",
    "1...1P1.........1....P11",
    "111.1.1.1.11111.1.111111",
    "1...1.1.1...1...1.1...11",
    "1.111.1.111.1.111.1.1.11",
    "1...1....P1.1.....1.1.11",
    "111.1111111.1111111.1.11",
    "1.1.....1...1.......1.11",
    "1.11111.1.111.1111111.11",
    "1.....1.1......P1...1.11",
    "1.11111.11111.111.1.1.11",
    "1.1.....1...1.1...1...LX",
    "1.1.11111.1.1.1.11111.11",
    "1.1.1.....1.1P1.....1.11",
    "1.1.11111.1.1111111.1.11",
    "1.1.....1.1.......1.1K11",
    "1.11111.1.1111111.1.1111",
    "1.....1.1...1...1.1...11",
    "1.11111.111.1.111.111.11",
    "1.1.....1...1.....1...11",
    "1.1.11111.111.11111.1.11",
    "1.........1.........1.11",
    "111111111111111111111111",
    "111111111111111111111111",
  ];
  ...
  const LEVEL_5 = {
    ...
    enemies: [
      ...
      { kind: "catcher", x: 11.5, y: 22.5, hp: 30, fireCd: 1.1 },
      { kind: "catcher", x: 4.5,  y: 16.5, hp: 30, fireCd: 1.1 },
      { kind: "catcher", x: 15.5, y: 18.5, hp: 30, fireCd: 1.2 },
      { kind: "catcher", x: 3.5,  y: 13.5, hp: 30, fireCd: 1.2 },
      { kind: "catcher", x: 16.5, y: 14.5, hp: 30, fireCd: 1.4 },
      { kind: "mascot",  x: 4.5,  y: 7.5,  hp: 55, fireCd: 1.5 },
      { kind: "mascot",  x: 13.5, y: 11.5, hp: 55, fireCd: 1.5 },
      { kind: "mascot",  x: 5.5,  y: 7.5,  hp: 55, fireCd: 1.5 },
      { kind: "mascot",  x: 17.5, y: 11.5, hp: 55, fireCd: 1.5 },
    ...
    pickups: [
      ...
      { kind: "ball", x: 11.5, y: 5.5  },
      { kind: "ball", x: 8.5,  y: 11.5 },
    ],
  };
  ...
  const LEVELS = [
    ...
    { map: L1_MAP, theme: "kennel", playerStart: { x: 1.5, y: 12.5, a: 0 }, damageMul: 1.0,
      ...
      enemies: [
        ...
        { kind: "catcher", x: 21.5, y: 17.5, hp: 30, fireCd: 1.5 },
      ], pickups: [
    ...
    { map: L2_MAP, theme: "garden", playerStart: { x: 1.5, y: 11.5, a: 0 }, damageMul: 1.15,
      ...
      enemies: [
        ...
        { kind: "toy",  x: 15.5, y: 9.5  },
        { kind: "ball", x: 13.5, y: 2.5  },
    ...
    { map: L3_MAP, theme: "cavern", playerStart: { x: 1.5, y: 11.5, a: 0 }, damageMul: 1.3,
      ...
      enemies: [
        ...
        { kind: "catcher", x: 15.5, y: 18.5, hp: 30, fireCd: 1.2 },
        { kind: "catcher", x: 21.5, y: 1.5,  hp: 30, fireCd: 1.2 },
        { kind: "catcher", x: 5.5,  y: 5.5,  hp: 30, fireCd: 1.2 },
        { kind: "catcher", x: 1.5,  y: 9.5,  hp: 30, fireCd: 1.2 },
        { kind: "catcher", x: 19.5, y: 19.5, hp: 30, fireCd: 1.2 },
        { kind: "mascot",  x: 21.5, y: 20.5, hp: 55, fireCd: 1.4 },
        { kind: "mascot",  x: 13.5, y: 7.5,  hp: 55, fireCd: 1.4 },
      ], pickups: [
        { kind: "toy",  x: 16.5, y: 13.5 },
        { kind: "toy",  x: 9.5,  y: 19.5 },
        { kind: "toy",  x: 5.5,  y: 1.5  },
        { kind: "toy",  x: 3.5,  y: 5.5  },
        { kind: "ball", x: 17.5, y: 17.5 },
        { kind: "ball", x: 21.5, y: 14.5 },
        { kind: "ball", x: 7.5,  y: 17.5 },
        { kind: "ball", x: 12.5, y: 9.5  },
        { kind: "ball", x: 5.5,  y: 15.5 },
    ...
    { map: L4_MAP, theme: "park", playerStart: { x: 1.5, y: 11.5, a: 0 }, damageMul: 1.45,
      ...
      enemies: [
        ...
        { kind: "catcher", x: 14.5, y: 9.5,  hp: 30, fireCd: 1.0 },
        { kind: "catcher", x: 13.5, y: 12.5, hp: 30, fireCd: 1.2 },
        { kind: "catcher", x: 1.5,  y: 1.5,  hp: 30, fireCd: 1.0 },
        { kind: "catcher", x: 10.5, y: 3.5,  hp: 30, fireCd: 1.0 },
        { kind: "catcher", x: 4.5,  y: 7.5,  hp: 30, fireCd: 1.0 },
        { kind: "catcher", x: 17.5, y: 11.5, hp: 30, fireCd: 1.0 },
        { kind: "catcher", x: 5.5,  y: 19.5, hp: 30, fireCd: 1.0 },
        { kind: "mascot",  x: 3.5,  y: 2.5,  hp: 55, fireCd: 1.3 },
        { kind: "mascot",  x: 20.5, y: 3.5,  hp: 55, fireCd: 1.3 },
        { kind: "mascot",  x: 18.5, y: 7.5,  hp: 55, fireCd: 1.3 },
        { kind: "mascot",  x: 7.5,  y: 13.5, hp: 55, fireCd: 1.3 },
      ], pickups: [
        { kind: "toy",  x: 21.5, y: 8.5  },
        { kind: "toy",  x: 19.5, y: 10.5 },
        { kind: "toy",  x: 10.5, y: 11.5 },
        { kind: "toy",  x: 5.5,  y: 13.5 },
        { kind: "ball", x: 6.5,  y: 15.5 },
        { kind: "ball", x: 3.5,  y: 7.5  },
        { kind: "ball", x: 17.5, y: 18.5 },
        { kind: "ball", x: 15.5, y: 21.5 },
        { kind: "ball", x: 3.5,  y: 19.5 },
        { kind: "ball", x: 5.5,  y: 5.5  },
        { kind: "ball", x: 5.5,  y: 17.5 },
      ] },
